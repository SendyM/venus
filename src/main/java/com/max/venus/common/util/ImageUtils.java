...
public class ImageUtils {
	 ...
	 * @throws Exception
	 */
	public static void autoRotateImage(final String src, String dest)
			throws Exception {
		try {
			...
			destinationImage = affineTransformOp.filter(originalImage,
					destinationImage);
			ImageIO.write(destinationImage,
	 ...
	 *            目标切片高度
	 */
	public final static void cut(File sourceImg, File output, int x, int y,
	 ...
	 * @throws IOException
	 */
	public final static void scale(File sourceImg, File output, int scale,
	 ...
	 *            比例不对时是否需要补白：true为补白; false为不补白;
	 */
	public final static void scale(File sourceImg, File output, int height,
	 ...
	 * @param width
	 */
	public final static void scaleByWidth(File sourceImg, File output, int width) {
		try {
			BufferedImage bi = ImageIO.read(sourceImg);
