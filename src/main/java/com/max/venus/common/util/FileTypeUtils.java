...
public final class FileTypeUtils {
	...
	static {
		...
		fileTypeMap.put("7b5c727466315c616e73", "rtf"); // Rich Text Format
														// (rtf)
		fileTypeMap.put("38425053000100000000", "psd"); // Photoshop (psd)
		fileTypeMap.put("46726f6d3a203d3f6762", "eml"); // Email [Outlook
														// Express 6] (eml)
		fileTypeMap.put("d0cf11e0a1b11ae10000", "doc"); // MS Excel 注意：word、msi
														// 和 excel的文件头一样
	...
	public static String getType(InputStream in) throws IOException {
		...
		return getType(HexUtils.encodeHexStr(readBytes(in, 28), false));
	}
