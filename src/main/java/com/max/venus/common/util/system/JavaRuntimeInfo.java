package com.max.venus.common.util.system;
...
public class JavaRuntimeInfo{
	...
	public final String[] getClassPathArray() {
		return getClassPath().split(SystemUtils.get("path.separator"));
	}
	...
	public final String[] getLibraryPathArray() {
		return getLibraryPath().split(SystemUtils.get("path.separator", false));
	}
