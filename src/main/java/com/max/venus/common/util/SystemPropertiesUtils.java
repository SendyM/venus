...
public class SystemPropertiesUtils {
	...
	public static Double getDouble(String propertyName) {
		return NumberConverUtils.toDoubleObject(System.getProperty(propertyName));
	}
	...
	public static Double getDouble(String propertyName, Double defaultValue) {
		Double propertyValue = NumberConverUtils.toDoubleObject(System.getProperty(propertyName));
	...
	public static Integer getInteger(String propertyName, String envName, Integer defaultValue) {
		checkEnvName(envName);
		Integer propertyValue = NumberConverUtils.toIntObject(System.getProperty(propertyName));
		if (propertyValue != null) {
			return propertyValue;
		} else {
			propertyValue = NumberConverUtils.toIntObject(System.getenv(envName));
			return propertyValue != null ? propertyValue : defaultValue;
		}
	}
	...
	public static Long getLong(String propertyName, String envName, Long defaultValue) {
		checkEnvName(envName);
		Long propertyValue = NumberConverUtils.toLongObject(System.getProperty(propertyName));
		if (propertyValue != null) {
			return propertyValue;
		} else {
			propertyValue = NumberConverUtils.toLongObject(System.getenv(envName));
			return propertyValue != null ? propertyValue : defaultValue;
		}
	}
	...
	public static Double getDouble(String propertyName, String envName, Double defaultValue) {
		...
		if (propertyValue != null) {
			...
			propertyValue = NumberConverUtils.toDoubleObject(System.getenv(envName));
			return propertyValue != null ? propertyValue : defaultValue;
		}
	}
