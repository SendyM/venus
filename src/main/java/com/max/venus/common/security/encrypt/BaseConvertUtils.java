...
public abstract class BaseConvertUtils {
    ...
    private static String stringToHexString(String input, String encoding)
    ...
    private static String hexStringToString(String input, String encoding)
        throws UnsupportedEncodingException{
    ...
    private static TimeZone stringToTimeZone(String tzString){
    ...
    private static String localeToString(Locale loc){

        return loc != null ? loc.toString() : "";
    }

    private static Locale stringToLocale(String locString){
