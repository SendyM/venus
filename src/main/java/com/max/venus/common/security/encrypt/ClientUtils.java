...
import com.max.venus.common.util.HttpClientUtils;
...
public class ClientUtils {
	 ...
	 * 服务器地址
	 */
	private static String serverUrl="http://localhost:8080/venus/encrypt/getserverpublickey";
	...
	public static Message sendMessage(String serverUrl,Serializable sendObject,Message tokenAndKeyMessage){
		...
		try {
			 response11 = HttpClientUtils.doPost(
					serverUrl,//"http://localhost:8081/venus/encrypt/encrypt",
